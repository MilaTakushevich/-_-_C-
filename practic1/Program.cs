...
else if (num_day == 2) // Заменена операция присваивания '=' на операцию сравнения '=='
{
    // Выводим название дня недели на консоль
    Console.WriteLine("Вторник");
}
else if (num_day == 3) // Заменена операция присваивания '=' на операцию сравнения '=='
{
    // Выводим название дня недели на консоль
    Console.WriteLine("Среда");
}
else if (num_day == 4) // Заменена операция присваивания '=' на операцию сравнения '=='
{
    // Выводим название дня недели на консоль
    Console.WriteLine("Четверг");
}
else if (num_day == 5) // Заменена операция присваивания '=' на операцию сравнения '=='
{
    // Выводим название дня недели на консоль
    Console.WriteLine("Пятница");
}
else if (num_day == 6) // Заменена операция присваивания '=' на операцию сравнения '=='
{
    // Выводим название дня недели на консоль
    Console.WriteLine("Суббота");
}
else if (num_day == 7) // Заменена операция присваивания '=' на операцию сравнения '=='
{
    // Выводим название дня недели на консоль
